...
class Timesheet(models.Model):
    ...
    duration = models.DecimalField(max_digits=3, decimal_places=1,null=True, blank=True)
...
class AutomationTimesheet(models.Model):
    ...
    default=TimesheetType.AUTO
)
    month = models.DateField( max_length=3, choices= MonthChoices.choices, default=MonthChoices.JANUARY )
...
class TimesheetEmailLog(models.Model):
    recipient = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL, related_name='email_logs')
    project_name = models.CharField(max_length=255)
    status = models.TextField()
    email_content = models.JSONField()  
    sent_at = models.DateTimeField(auto_now_add=True)
    sent_by = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL, related_name='sent_emails')
