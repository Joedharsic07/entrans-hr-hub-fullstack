...
urlpatterns = [
    ...
    path('users/<int:user_id>/projects/', ProjectListCreateView.as_view(), name='user-projects'),
    ...
    path('time-tracking/validation/', TimeTrackingAPI.as_view(), name='time-tracking-validation'),
    path('time-tracking/templates/', TimeTrackingTemplateAPI.as_view(), name='time-tracking-templates'),
    path('time-tracking/templates/<str:filename>/', TimeTrackingTemplateAPI.as_view(), name='time-tracking-template-download'),
    path('time-tracking/send-email/', TimeTrackingEmailAPI.as_view(), name='time-tracking-email'),
    ...
    path('validate-multiple-timesheets/', ValidateMultipleTimesheetView.as_view(), name='validate-multiple-timesheets'),
